import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.ac004ed7.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"font-end/html_css/iq.md","filePath":"font-end/html_css/iq.md","lastUpdated":1699863567000}'),l={name:"font-end/html_css/iq.md"},p=e(`<h2 id="_1-bfc" tabindex="-1">1.BFC <a class="header-anchor" href="#_1-bfc" aria-label="Permalink to &quot;1.BFC&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">BFC是块级格式上下文，指一个独立的渲染区域</span></span>
